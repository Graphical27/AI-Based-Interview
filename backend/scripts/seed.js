...
const jobsData = [
  { title:'Senior React Developer', company:'TechFlow Inc.', location:'Remote', type:'Full-time', salary:'$120k - $150k', remote:true, tags:['React','TypeScript','Node.js','GraphQL'], category:'Engineering', urgent:true, verified:true, description:'We are looking for a Senior React Developer to join our dynamic team and help build the next generation of web applications.', logo:'🚀', postedAt: daysAgo(2), interviewDurationMinutes: 30 },
  { title:'Data Scientist', company:'DataMinds Analytics', location:'New York, NY', type:'Full-time', salary:'$110k - $140k', remote:false, tags:['Python','ML','TensorFlow','Pandas'], category:'Data', urgent:false, verified:true, description:'Join our data science team to extract insights from complex datasets and build machine learning models.', logo:'📊', postedAt: daysAgo(7), interviewDurationMinutes: 45 },
  ...
  { title:'Product Manager', company:'InnovateCorp', location:'San Francisco, CA', type:'Full-time', salary:'$130k - $160k', remote:false, tags:['Strategy','Agile','Analytics','Roadmaps'], category:'Product', urgent:true, verified:true, description:'Drive product strategy and execution for our flagship products. Work closely with engineering and design teams.', logo:'🎯', postedAt: daysAgo(5), interviewDurationMinutes: 30 },
  { title:'DevOps Engineer', company:'CloudTech Solutions', location:'Remote', type:'Full-time', salary:'$115k - $145k', remote:true, tags:['AWS','Docker','Kubernetes','CI/CD'], category:'Engineering', urgent:false, verified:true, description:'Help scale our cloud infrastructure and streamline deployment processes.', logo:'☁️', postedAt: daysAgo(3), interviewDurationMinutes: 20 },
  { title:'Frontend Developer', company:'WebCraft Agency', location:'Seattle, WA', type:'Full-time', salary:'$95k - $125k', remote:false, tags:['Vue.js','JavaScript','CSS','HTML5'], category:'Engineering', urgent:false, verified:true, description:'Build beautiful and responsive user interfaces for our growing platform.', logo:'💻', postedAt: daysAgo(6), interviewDurationMinutes: 15 },
  { title:'Full Stack Developer', company:'ScaleDB', location:'Chicago, IL', type:'Full-time', salary:'$100k - $140k', remote:true, tags:['Node.js','React','PostgreSQL','APIs'], category:'Engineering', urgent:false, verified:true, description:'Build scalable web applications using modern JavaScript technologies and cloud services.', logo:'⚡', postedAt: daysAgo(4), interviewDurationMinutes: 30 },
  { title:'Machine Learning Engineer', company:'AI Innovations', location:'Boston, MA', type:'Full-time', salary:'$140k - $170k', remote:true, tags:['Python','TensorFlow','PyTorch','MLOps'], category:'Data', urgent:true, verified:true, description:'Build and deploy machine learning models at scale. Experience with deep learning frameworks required.', logo:'🤖', postedAt: daysAgo(2), interviewDurationMinutes: 45 },
];
