...
const DashboardView = ({ user }) => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      default: return `${theme.textMuted} bg-gray-400/10 border-gray-400/30`;
    }
  };
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        <div className={theme.text}>Loading dashboard...</div>
      </div>
    );
  }
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {[
            ...
            <div key={index} className={`p-6 rounded-2xl ${theme.glassPanel} border ${theme.border} hover:border-gray-700/50 transition-all group`}>
              ...
              <div>
                <p className={`${theme.textMuted} text-sm font-medium mb-1`}>{stat.label}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className={`p-6 rounded-2xl ${theme.glassPanel} border ${theme.border} hover:border-green-400/30 transition-all group cursor-pointer`}>
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className={`text-lg font-semibold ${theme.text}`}>Find New Jobs</h3>
            </div>
            <p className={`${theme.textMuted} text-sm mb-4`}>Discover opportunities that match your skills and preferences</p>
            <button 
          ...
          <div className={`p-6 rounded-2xl ${theme.glassPanel} border ${theme.border} hover:border-purple-400/30 transition-all group cursor-pointer`}>
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className={`text-lg font-semibold ${theme.text}`}>Practice Interview</h3>
            </div>
            <p className={`${theme.textMuted} text-sm mb-4`}>Prepare for upcoming interviews with AI-powered mock sessions</p>
          ...
          <div className={`p-6 rounded-2xl ${theme.glassPanel} border ${theme.border} hover:border-blue-400/30 transition-all group cursor-pointer`}>
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className={`text-lg font-semibold ${theme.text}`}>Update Resume</h3>
            </div>
            <p className={`${theme.textMuted} text-sm mb-4`}>Keep your resume current with latest experiences and skills</p>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          <div className={`${theme.glassPanel} border ${theme.border} rounded-2xl p-6`}>
            <div className="flex items-center justify-between mb-6">
              <h3 className={`text-xl font-bold ${theme.text}`}>Recent Applications</h3>
              <button 
            ...
            <div className="space-y-4">
              {applications.slice(0, 4).map(app => (
                <div key={app.id} className={`flex items-center gap-4 p-4 rounded-xl ${theme.inputBg} border ${theme.border} hover:bg-white/5 transition-all cursor-pointer`}>
                  <div className={`w-12 h-12 rounded-xl ${theme.iconBg} border ${theme.border} flex items-center justify-center text-xl shadow-lg`}>
                    {app.logo || '💼'}
                  </div>
                  <div className="flex-1 min-w-0">
                    <h4 className={`font-semibold ${theme.text} text-sm truncate`}>{app.job}</h4>
                    <p className={`${theme.textMuted} text-xs`}>{app.company} • {app.stage}</p>
                  </div>
                  <div className="text-right">
          ...
          <div className={`${theme.glassPanel} border ${theme.border} rounded-2xl p-6`}>
            <div className="flex items-center justify-between mb-6">
              <h3 className={`text-xl font-bold ${theme.text}`}>Upcoming Interviews</h3>
              <button 
            ...
            <div className="space-y-4">
              {interviews.filter(i => i.status === 'scheduled').map(interview => (
                <div key={interview.id} className={`flex items-center gap-4 p-4 rounded-xl ${theme.inputBg} border ${theme.border} hover:bg-white/5 transition-all cursor-pointer`}>
                  <div className={`w-12 h-12 rounded-xl ${theme.iconBg} border ${theme.border} flex items-center justify-center text-xl shadow-lg`}>
                    {interview.logo || '📅'}
                  </div>
                  <div className="flex-1 min-w-0">
                    <h4 className={`font-semibold ${theme.text} text-sm truncate`}>{interview.role}</h4>
                    <p className={`${theme.textMuted} text-xs`}>{interview.company} • {interview.interviewer}</p>
                  </div>
                  <div className="text-right">
        ...
        {/* Recent Activity */}
        <div className={`${theme.glassPanel} border ${theme.border} rounded-2xl p-6`}>
          <h3 className={`text-xl font-bold ${theme.text} mb-6`}>Recent Activity</h3>
          <div className="space-y-4">
            {activities.map(activity => (
              <div key={activity.id} className={`flex items-center gap-4 p-4 rounded-xl ${theme.inputBg} border ${theme.border}`}>
                <div className={`w-10 h-10 rounded-lg ${theme.iconBg} flex items-center justify-center text-lg`}>
                  {activity.icon || '📝'}
                </div>
                <div className="flex-1">
                  <p className={`${theme.text} text-sm`}>{activity.message}</p>
    ...
    return (
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          <div>
            <h2 className={`text-2xl font-bold ${theme.text}`}>My Applications</h2>
            <p className={`${theme.textMuted} mt-1`}>Track and manage your job applications</p>
          </div>
          <button 
            onClick={() => setActiveTab('overview')}
            className={`flex items-center gap-2 px-4 py-2 ${theme.textMuted} hover:text-green-400 border ${theme.border} hover:border-green-400/50 rounded-xl transition-all`}
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          <div className="xl:col-span-2 space-y-6">
            {applications.map(app => (
              <div 
                key={app.id}
                className={`p-6 rounded-2xl ${theme.glassPanel} border cursor-pointer transition-all hover:shadow-xl ${
                  selectedApplication?.id === app.id 
                    ? 'border-green-400 ring-2 ring-green-400/20' 
                    : `${theme.border} hover:border-gray-700`
                }`}
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between">
                      <div>
                        <h3 className={`text-lg font-bold ${theme.text} mb-1`}>{app.job}</h3>
                        <p className="text-green-400 font-semibold">{app.company}</p>
                        <p className={`${theme.textMuted} text-sm mt-1`}>{app.stage}</p>
                      </div>
                      <div className="text-right">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button className={`px-4 py-2 text-xs ${theme.inputBg} hover:bg-white/10 ${theme.textMuted} border ${theme.border} rounded-lg transition-all`}>
                      View Details
                    </button>
          ...
          <div className="xl:col-span-1">
            {selectedApplication ? (
              <div className={`${theme.glassPanel} border ${theme.border} rounded-2xl p-6 sticky top-6`}>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className={`text-xl font-bold ${theme.text} mb-1`}>{selectedApplication.job}</h3>
                ...
                <div className="space-y-4 mb-6">
                  <div className={`p-3 rounded-xl ${theme.inputBg} border ${theme.border}`}>
                    ...
                    <p className={`text-sm ${theme.text}`}>{selectedApplication.stage}</p>
                  </div>
                  <div className={`p-3 rounded-xl ${theme.inputBg} border ${theme.border}`}>
                  ...
                  <div className={`p-3 rounded-xl ${theme.inputBg} border ${theme.border}`}>
                    ...
                    <p className={`text-sm ${theme.text}`}>{selectedApplication.date}</p>
                  </div>
                  <div className={`p-3 rounded-xl ${theme.inputBg} border ${theme.border}`}>
                ...
                <div className="space-y-3">
                  ...
                  <button className={`w-full ${theme.inputBg} hover:bg-white/10 ${theme.textMuted} border ${theme.border} font-medium py-3 px-4 rounded-xl transition-all`}>
                    View Job Details
                  </button>
              ...
              <div className={`${theme.glassPanel} border ${theme.border} rounded-2xl p-8 text-center sticky top-6`}>
                <div className="text-gray-500 mb-6">
                  <svg className="w-20 h-20 mx-auto mb-4 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                  </svg>
                </div>
                <h3 className={`text-xl font-bold ${theme.text} mb-3`}>Select an Application</h3>
                <p className={`${theme.textMuted} text-sm`}>Click on any application to view details and manage your progress</p>
              </div>
            )}
          </div>
        </div>
  ...
  if (activeTab === 'interviews') {
    return (
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          <div>
            <h2 className={`text-2xl font-bold ${theme.text}`}>Interview Schedule</h2>
            <p className={`${theme.textMuted} mt-1`}>Manage your upcoming and past interviews</p>
          </div>
          <button 
            onClick={() => setActiveTab('overview')}
            className={`flex items-center gap-2 px-4 py-2 ${theme.textMuted} hover:text-green-400 border ${theme.border} hover:border-green-400/50 rounded-xl transition-all`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <h3 className={`text-lg font-bold ${theme.text}`}>Upcoming Interviews</h3>
            {interviewData.filter(i => i.status === 'scheduled').map(interview => (
              <div key={interview.id} className={`p-6 rounded-2xl ${theme.glassPanel} border ${theme.border} hover:border-gray-500/30 transition-all`}>
                <div className="flex items-start gap-4 mb-4">
                  <div className={`w-14 h-14 rounded-xl ${theme.iconBg} border ${theme.border} flex items-center justify-center text-2xl shadow-lg`}>
                    {interview.logo}
                  </div>
                  <div className="flex-1">
                    <h4 className={`text-lg font-bold ${theme.text} mb-1`}>{interview.role}</h4>
                    <p className="text-green-400 font-semibold">{interview.company}</p>
                    <p className={`${theme.textMuted} text-sm mt-1`}>with {interview.interviewer}</p>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className={`p-3 rounded-xl ${theme.inputBg} border ${theme.border}`}>
                    ...
                    <p className={`text-sm ${theme.text}`}>{interview.date}</p>
                  </div>
                  <div className={`p-3 rounded-xl ${theme.inputBg} border ${theme.border}`}>
                    <p className="text-xs text-gray-500 font-medium">Time</p>
                    <p className={`text-sm ${theme.text}`}>{interview.time}</p>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <h3 className={`text-lg font-bold ${theme.text}`}>Completed Interviews</h3>
            {interviewData.filter(i => i.status === 'completed').map(interview => (
              <div key={interview.id} className={`p-6 rounded-2xl ${theme.glassPanel} border ${theme.border} opacity-75`}>
                <div className="flex items-start gap-4 mb-4">
                  <div className={`w-14 h-14 rounded-xl ${theme.iconBg} border ${theme.border} flex items-center justify-center text-2xl shadow-lg`}>
                    {interview.logo}
                  </div>
                ...
                <div className="flex gap-3">
                  <button className={`flex-1 ${theme.inputBg} hover:bg-white/10 ${theme.textMuted} border ${theme.border} font-medium py-2 px-4 rounded-lg transition-all text-sm`}>
                    View Feedback
                  </button>
